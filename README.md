...
*   **Use `gemini-1.5-flash-lite` or `gemini-2.0-flash`**: They're fast, basically free at low volumes, and plenty smart enough for this. 
*   **Granular Selection**: You can (and should) set different models for Extraction, Translation, and Normalization in **Settings**. Use Flash for extraction and Pro for normalization if you're dealing with a nightmare EPUB.
*   **Avoid the "Pro" models for everything**: You'll hit your rate limits in minutes on the free tier.
*   **Track your usage**: You can track your usage on the same place you get your API key from.
